...
if(isset($_POST['insert_brand'])){              
    ...
    if($result){                                               //condition
        echo"<script>alert('Brand has been inserted sucessfully')</script>";           //basic concept of js
    }
}}           
?>
...
<form action="" method="post" class="mb-2">
    <div class="input-group w-90 mb-2">    <!-- we don't have to insert bootstrap here coz we have already nsert it in index.php-->
        ...
        <input type="text" class="form-control" name="brand_title" placeholder="Insert Brands" aria-label="brands" aria-describedby="basic-addon1"> <!-- class form control helps bootstrap class wiil be applied-->
        </div>

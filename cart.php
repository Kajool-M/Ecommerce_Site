    ...
    <div class="row">
            ...
            <tbody>";
             while($row=mysqli_fetch_array($result)){
                 ...
                 while($row_product_price=mysqli_fetch_array($result_products)){
                     ...
                     $price_table=$row_product_price['product_price'];           //normal price
            ...
            ?>
                ...
                <tr>
                    <td><?php echo $product_title?></td>
                                    <!-- here in img we added admin_area so that the img can be load from db instead of images folder -->
        ...
        <div class="d-flex mb-3">
            <?php
                    ...
                    $result_count=mysqli_num_rows($result);
                    if($result_count>0){
                        echo"  <h4 class='px-3'>Subtotal:<strong class='text-success'>Rs. $total_price</strong></h4>
                        <input type='submit' value=Keepshopping class='bg-info px-3 py-2 border-0 mx-3  ' name='keep_shopping'>
                        <button class='bg-secondary px-3 py-2 border-0'><a href='./users_area/checkout.php' class=' text-light text-decoration-none'>Checkout</a></buttom>";
                    }else{
                       echo" <input type='submit' value='Keepshopping' class='bg-info px-3 py-2 border-0 mx-3' name='keep_shopping'>";
                    }
                    if(isset($_POST['keep_shopping'])){
